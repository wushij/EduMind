      ...
      <template #footer>
        <div class="dialog-footer-actions">
          ...
          >
            ...
            <el-icon v-else class="mr-1"><Key /></el-icon>
            <span>确认重置密码</span>
          </button>
        </div>
      </template>
...
import { ArrowLeft, Key, Lock, Unlock, User, Clock, WarningFilled, Loading } from '@element-plus/icons-vue';
...
// 重置密码高定弹窗样式
:deep(.custom-reset-password-dialog) {
