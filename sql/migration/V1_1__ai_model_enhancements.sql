-- =============================================================================
-- V1.2 AI 模型运维与思考链（合并迁移，须在 V2_0_0 之后执行）
-- 智教云 · EduMind
--
-- 合并来源：
--   · V1_2_0__ai_model_config_ops.sql
--   · V1_2_1__ai_message_reasoning.sql
--
-- 执行：mysql -u root -p edumind < sql/migration/V1_1__ai_model_enhancements.sql
